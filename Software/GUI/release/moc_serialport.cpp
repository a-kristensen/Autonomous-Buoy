...
QT_MOC_LITERAL(1, 11, 12), // "dataRecieved"
QT_MOC_LITERAL(2, 24, 0), // ""
QT_MOC_LITERAL(3, 25, 14) // "serialRecieved"

    },
    "Serialport\0dataRecieved\0\0serialRecieved"
};
...
void Serialport::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->dataRecieved((*reinterpret_cast< QByteArray(*)>(_a[1]))); break;
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Serialport::dataRecieved)) {
                *result = 0;
                return;
            }
        }
